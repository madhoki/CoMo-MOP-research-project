...
# Combine means (simple average)
ensemble_mean = mean_preds_arr.mean(axis=0)

# Combine std devs using law of total variance
# Var_total = E[Var] + Var[Mean]
...
# Calibrate stds to better match abs error
reg = Ridge()
...
# Evaluate coverage (±1 calibrated std)
...
# Visualize: Parity plot with calibrated error bars
